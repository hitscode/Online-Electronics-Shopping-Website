...
<div class="col-xs-12 col-md-4" style="margin-top: 15px; " >              
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <h3 class="panel-title" style="text-align: center">TV 2</h3>
                    </div>
                    <div class="panel-body" >
                        <center>
                    <img src="images/tv2.jpeg" alt="TV 2" style="height:170px;" />
                <div class="caption">
                    <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#tv2" style="margin-top: 8px;">Click For Description</button>

                    <h3 style="font-weight:bold; "class="text-primary">Samsung UA43AUE70AK  43 Inch LED 4K, 3840 X 2160 Pixels TV</h3>
...
<!-- Modal -->
<div class="modal fade" id="tv2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
          <h3 class="modal-title text-center text-capitalize text-primary" id="exampleModalLabel "style="font-weight: bolder;">Samsung UA43AUE70AK  43 Inch LED 4K, 3840 X 2160 Pixels TV</h3>
      ...
      <div class="modal-body">
        <ul class="list-group">
  <li class="list-group-item text-info text-center">Size - 43 Inch  Resolution- 4K, 3840 x 2160 Pixels</li>
  <li class="list-group-item text-info text-center">Refresh Rate- 60 Hz Sound- Total Speaker output 20 W</li>
  <li class="list-group-item text-info text-center">Connectivity Port - USB Ports -1 & HDMI Ports-3
Warranty- 1 Year</li>
